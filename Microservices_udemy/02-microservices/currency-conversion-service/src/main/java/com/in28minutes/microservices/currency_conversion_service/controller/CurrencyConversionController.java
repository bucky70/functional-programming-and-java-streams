...
import com.in28minutes.microservices.currency_conversion_service.CurrencyConversion;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversion(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity){
        ...
        BigDecimal totalCalculatedAmount=currencyConversion.getQuantity().multiply(currencyConversion.getConversionMultiple());
    ...
    public CurrencyConversion calculateCurrencyConversionFeign(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity){
        ...
        BigDecimal totalCalculatedAmount=currencyConversion.getQuantity().multiply(currencyConversion.getConversionMultiple());
        currencyConversion.setTotalCalculatedAmount(totalCalculatedAmount);
        currencyConversion.setEnvironment(currencyConversion.getEnvironment()+" open feign");
        return currencyConversion;
        //return new CurrencyConversion(10001L,from, to,  BigDecimal.ONE,quantity,BigDecimal.ONE,"");
    }
}
